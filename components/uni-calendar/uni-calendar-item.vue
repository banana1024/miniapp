        ...
        <block
          ...
          >
            <view class="uni-calender__circle-box">
              ...
              <view
                v-if="day.have && !lunar && day.clockinfo.info != '补签'"
                class="uni-calender__lunar">{{ day.clockinfo.info }}</view>
				<view class="buqian" v-if="day.have && !lunar && day.clockinfo.info == '补签'">
					<button type="primary" size="mini" class="bqinput" style="font-size: 20rpx;background:#1F15ED;border-radius: 20px;">补签</button>
				</view>
            </view>
